const level3 = {
  ...
  platforms: [
    ...
    { x: 230, y: 565, width: 150, height: 24 },
    { x: 520, y: 520, width: 170, height: 24 },
    { x: 820, y: 470, width: 170, height: 24 },
    { x: 1170, y: 420, width: 170, height: 24 },
    { x: 1520, y: 545, width: 170, height: 24 },
    { x: 1870, y: 500, width: 150, height: 24 },
    { x: 2240, y: 455, width: 170, height: 24 },
    { x: 2620, y: 510, width: 150, height: 24 },
    { x: 3010, y: 470, width: 170, height: 24 },
    { x: 3390, y: 520, width: 170, height: 24 }
  ],
  hazards: [
